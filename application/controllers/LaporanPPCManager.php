...
class LaporanPPCManager extends CI_Controller {
	public $id_doc = 0;	
	...
	public function index()
	{
		...
		$this->load->view('manager/page_laporanPPC_utama',$data);
	...
	public function view_dokumen($id_doc){
		...
		$this->load->view('manager/templates/header', $data);
		$this->load->view('manager/templates/sidebar', $data);
		$this->load->view('manager/page_laporanPPC_view',$data);
		$this->load->view('manager/templates/footer');
	}
	...
	public function cetak_laporan($id_doc){
		...
		$this->load->view('manager/templates/header', $data);
		$this->load->view('manager/templates/sidebar', $data);
		$this->load->view('manager/page_laporanPPC_cetak',$data);
		$this->load->view('manager/templates/footer');
	}
