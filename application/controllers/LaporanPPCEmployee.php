...
class LaporanPPCEmployee extends CI_Controller {
	public $id_doc = 0;	
	...
	public function index()
	{
		...
		$data['data']	= $this->db_model->list_dok_ppc()->result_object();		
		...
		$this->load->view('employee/page_laporanPPC_utama',$data);
	...
	public function view_dokumen($id_doc){
		...
		$this->load->view('employee/templates/header', $data);
		$this->load->view('employee/templates/sidebar', $data);
		$this->load->view('employee/page_laporanPPC_view',$data);
		$this->load->view('employee/templates/footer');
	}
	...
	public function cetak_laporan($id_doc){
		...
		$this->load->view('employee/templates/header', $data);
		$this->load->view('employee/templates/sidebar', $data);
		$this->load->view('employee/page_laporanPPC_cetak',$data);
		$this->load->view('employee/templates/footer');
	}
	...
	public function filterdate(){
		...
		$this->load->view('employee/templates/header', $data);
		$this->load->view('employee/templates/sidebar', $data);
		$this->load->view('employee/page_laporan',$data);
		$this->load->view('employee/templates/footer');
