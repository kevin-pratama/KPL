...
class Dokumen_svrEmployee extends CI_Controller {
	public $id_doc = 0;	
	...
	{				
		...
		$this->load->view('employee/page_dokumen_svr',$data);
	...
	public function edit_dokumen($id_doc){
		...
		$this->load->view('employee/templates/header', $data);
		$this->load->view('employee/templates/sidebar', $data);
		$this->load->view('employee/page_dokumen_edit',$data);
		$this->load->view('employee/templates/footer');	
  ...
  <tr>
   ...
   <tr>
	...
	public function cetak_dokumen($id_doc){
		...
		$this->load->view('employee/page_surattugas_svr',$data);
