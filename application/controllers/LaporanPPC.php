...
class LaporanPPC extends CI_Controller {
	public $id_doc = 0;	
	...
	public function index()
	{
		...
		$this->load->view('admin/page_laporanPPC_utama',$data);
	...
	public function view_dokumen($id_doc){
		...
		$this->load->view('admin/templates/header', $data);
		$this->load->view('admin/templates/sidebar', $data);
		$this->load->view('admin/page_laporanPPC_view',$data);
		$this->load->view('admin/templates/footer');
	}
	...
	public function cetak_laporan($id_doc){
		...
		$this->load->view('admin/templates/header', $data);
		$this->load->view('admin/templates/sidebar', $data);
		$this->load->view('admin/page_laporanPPC_cetak',$data);
		$this->load->view('admin/templates/footer');
	}
