            ...
            <div class="page-content">
				...
				<div class="row">
					...
					<div class="panel-body" >
						...
						<form method="post" class="form-horizontal" action="<?php echo base_url('laporanManager/update/'.$id_doc) ?>" enctype="multipart/form-data">
                            <div class="panel panel-default">                                
                        ...
                        <tr>
                         ...
                         ?>                       
                                ...
                                <div class="panel-footer">
                                    <button type="reset" class="btn btn-default" onclick="location.href='<?php echo base_url();?>laporanManager';">
