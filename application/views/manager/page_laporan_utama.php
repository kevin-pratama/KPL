        ...
        <div class="content-wrapper">
            ...
            <div class="page-content">
				...
				<div class="row">
                    ...
                    <form method="post" class="form-horizontal" action="<?php echo base_url(); ?>laporanManager/filterdate" enctype="multipart/form-data">
                        ...
                        <form method="post" class="form-horizontal" action="<?php echo base_url(); ?>laporanManager/filterpegawai" enctype="multipart/form-data">
                    ...
                    <tbody>
                        ...
                        ?>                      
                            ...
                            <div class="btn-group" role="group">                            
                                ...
                                <button>
                                    <a href="<?php echo base_url(); ?>LaporanManager/view_dokumen/<?php echo $row->id_doc;?>">
                                    <span class="fa fa-pencil">Edit</span></a>
                                </button>
                                <button>
                                    <a href="<?php echo base_url(); ?>LaporanManager/cetak_Laporan/<?php echo $row->id_doc;?>" target="_blank"> 
