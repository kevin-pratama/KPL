<!-- START PAGE CONTAINER -->
        <div class="content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                <li><a href="<?php echo base_url();?>employee">Dashboard</a></li>
                ...
                <table class="table datatable">
					...
					<tbody>
                    	...
                    	<tr>						
                            ...
                            <td align="center"><?php echo $row->menimbang?></td>
                            
                            <td><?php echo word_limiter($row->keperluandl,2000).'  <br>(jml kata: '.str_word_count($row->keperluandl).')'; ?>
							</td>
							<td><?php echo word_limiter($row->tujuandl,2000).'  <br>(jml kata: '.str_word_count($row->tujuandl).')'; ?>
							</td>
						...
						<td align="center">
							<div class="btn-group" role="group">                            
								                ...
								                <button>
                                    <a href="<?php echo base_url(); ?>SppdEmployee/cetak_sppd/<?php echo $row->id_doc;?>" 
