...
<div class="content-wrapper">
            ...
            <div class="page-content">
                ...
                <li><a href="<?php echo base_url();?>admin">Dashboard</a></li>
                    <li class="active">LaporanEmployee</li>
                </ul>
                <!-- END BREADCRUMB -->               
				...
				<div class="row">
                    ...
                    <div class="panel panel-default">
					<div class="panel-heading">
                        <h3 class="panel-title">LaporanEmployee</h3>
					</div>
                    </div>
                ...
                <table class="table datatable">
                    <thead>
                        <tr>
                            ...
                            <th width="5%"><center>Jenis Kegiatan</th>
                            <th width="10%"><center>No Surat</th>
                            <th><center>Deskripsi Surat Tugas</th>
                            <th width="5%"><center>Tanggal Permohonan</th>
                    ...
                    <tbody>
                        ...
                        ?>                      
                            ...
                            <div class="btn-group" role="group">                            
                                ...
                                <button>
                                    <a href="<?php echo base_url(); ?>LaporanEmployee/view_dokumen/<?php echo $row->id_doc;?>">
                                    <span class="fa fa-pencil"></span></a>
                                </button>

                                <button>
                                    <a href="<?php echo base_url(); ?>LaporanEmployee/cetak_Laporan/<?php echo $row->id_doc;?>" 
                                    <span class="fa fa-print"></span></a>
                                </button>

                                <!-- <button>
                                    <a href="<?php echo base_url(); ?>Laporan/cetak_laporan_vdua/<?php echo $row->id_doc;?>"                                     
                                    <span class="fa fa-print"></span></a>
                                </button> -->
