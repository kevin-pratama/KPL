...
<div class="content-wrapper">
            ...
            <div class="page-content">
				...
				<div class="row">
                    ...
                    <form method="post" class="form-horizontal" action="<?php echo base_url(); ?>laporanPPCManager/filterdate" enctype="multipart/form-data">

                        <div class="pull-left">
                            Tanggal Berangkat:
                            <input type="text" class="form-control pull-left" name='tanggal_berangkat' id="datepicker">
                        </div>

                        <div class="pull-left">
                            Tanggal Pulang:
                            <input type="text" class="form-control pull-right" name='tanggal_pulang' id="datepicker2">
                        </div>
                        <div class="pull-left">
                            Filter
                            <br>
                        ...
                        <form method="post" class="form-horizontal" action="<?php echo base_url(); ?>laporanPPCManager/filterpegawai" enctype="multipart/form-data">
                    ...
                    <tbody>
                        ...
                        ?>                      
                            ...
                            <div class="btn-group" role="group">                            
                                ...
                                <button>
                                    <a href="<?php echo base_url(); ?>LaporanPPCManager/view_dokumen/<?php echo $row->id_doc;?>">
                                    <span class="fa fa-pencil">Edit</span></a>
                                </button>
                                <button>
                                    <a href="<?php echo base_url(); ?>LaporanPPCManager/cetak_Laporan/<?php echo $row->id_doc;?>" target="_blank"> 
