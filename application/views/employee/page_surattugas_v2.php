...
<tr>
    ...
    <br>
     ...
     <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>><td valign="top">:</td>
    ...
    <tr><td align=center style="font-size:14px;">Memberi Tugas</td></tr> 
     ...
     <td valign="top" text-align="justify">Para pegawai yang namanya tercantum dalam lampiran Surat Tugas ini</td>
     <td valign="top"></td>
   ...
   <table border=0  width="100%" cellspacing="0" cellpadding="2" 
     ...
     <td valign="top" text-align="justify"> '.$keperluandl.' Pada Tanggal '.$tanggal_berangkat.' s/d '.$tanggal_pulang.' Di '.$tujuandl.'. </td>
     </tr>
     <tr></tr>
     <tr></tr>
     <tr></tr>
  ...
  <tr>
    ...
    <td width="30%">
     ...
     <td >
        ...
        <table>
            <tr><td width="200px">Semarang,  '.$tanggalttd.'</td></tr>
  ...
  <tr>
    ...
    <td width="30%">
     ...
     <td >
        ...
        <table>
            <tr><td width="100px">Lampiran Surat Tugas</td></tr>
            <tr><td width="200px">Nomor   : '.$substr_awal.''.$substr_nosurat.'</td></tr>
            
            <tr><td width="40px">Tanggal :'.$tanggalttd.'</td></tr>
