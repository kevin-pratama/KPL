                    ...
                    <div class="panel-body" id="exportTable" style="display: none;">
                        <div class="row">
                            <div class="col-md-12">
                               ...
                               <form method="post" class="form-horizontal" action="<?php echo base_url(); ?>dokumen/submit" enctype="multipart/form-data">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-xs-3">
                                                    <select id="no_ppk" class="form-control select2" name='no_ppk' data-placeholder="No. PPK" style="width: 100%;" onchange="return autofill();">
                                            ...
                                            <div class="form-group">
                                                 <label class="col-md-3 col-xs-12 control-label">Menimbang</label>
                                                    <div class="col-md-6 col-xs-12">     
                                                    <textarea class="form-control" name="menimbang" rows="3" placeholder="Enter ..."></textarea>     
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    ...
                                                    <textarea class="form-control" name="dasar" id="myDokumen" rows="5">
                                            a. Permen KP Nomor 05 Tahun 2005 tentang Tindakan karantina Ikan untuk pengeluaran MP HPIK
                                            b. Permen KP Nomor 20 tahun 2007 tentang Tindakan Karantina Ikan untuk Pemasukan MP HPIK dari luar negeri dan suatu area ke area lain di dalam wilayah Negara Republik Indonesia
                                            c. Biaya Perjalanan Dinas kegiatan ini dibebankan pada DIPA Balai KIPM Semarang Nomor DIPA-032.13.2.649661/2019 Tanggal 05 November 2018
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-xs-10">
                                                    <input id="perusahaan" class="form-control " name='trader[]' data-placeholder="Pilih Perusahaan" style="width: 100%;">
                                                        <!-- <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-xs-3">
                                                    <select class="form-control select2" multiple="multiple" name='pegawai[]' data-placeholder="Pilih Pegawai DL" style="width: 100%;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <input id="komoditas" type="text" class="form-control" name='tujuandl' placeholder="Enter ...">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    ...
                                                    <select class="form-control select2" name='keperluandl' style="width: 100%;">
                                                        <option selected="selected">Melaksanakan Pengawalan dan Pengambilan Contoh Media Pembawa</option>
                                                        <option>Melaksanakan Pengawalan Media Pembawa</option>
                                                        <option>Melaksanakan Pengambilan Contoh</option>
                                                        <option>Melaksanakan Stuffing</option>
							...
							<span class=\"label label-primary\"><i class=\"fa fa-eye\"></i> view</span>
                                        ...
                                        <td align="center">
                                            <div class="btn-group" role="group">
                                                ...
                                                <button>
                                                    <a href="<?php echo base_url(); ?>dokumen/edit_dokumen/<?php echo $row->id_doc; ?>">
                                                        <span class="fa fa-pencil"></span></a>
                                                </button>

                                                <button>
                                                    <a href="<?php echo base_url(); ?>dokumen/delete_dokumen/<?php echo $row->id_doc; ?>" onclick="javascript: return confirm('Are you sure delete ? ')">
                                                        <span class="fa fa-trash-o"></span></a>
                                                </button>
                                                <button>
                                                    <a href="<?php echo base_url(); ?>dokumen/cetak_dokumen/<?php echo $row->id_doc; ?>" <span class="fa fa-print"></span></a>
                                                </button>
                                                <button>
                                                    <a href="<?php echo base_url(); ?>dokumen/kirim_surat/<?php echo $row->id_doc; ?>" <span class="fa fa-fw fa-mail-forward"></span></a>
                                                </button>
...
<script>
    function autofill() {
        var no_ppk = document.getElementById('no_ppk').value;
        $.ajax({
            url: "<?php echo base_url(); ?>dokumen/cari",
            data: '&no_ppk=' + no_ppk,
            success: function(data) {
