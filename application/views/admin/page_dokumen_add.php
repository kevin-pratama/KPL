                                ...
                                <div class="panel-body">                                                                <div class="form-group">
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-3 control-label">ID DOC</label>
                                           <div class="col-md-3 col-xs-3">
                                             <input type="text" class="form-control" name="id_doc"/>    
                                            </div> 
                                    </div>        
                                      <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name='nosurat'  /> 
                                        ...
                                        <div class="form-group">
                                         <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">No Surat Otomatis</label>
                                        <div class="col-md-3 col-xs-3">
                                      <input type="text" class="form-control" name='vnosurat'/> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <input type="date" name="tanggal_pulang" />
                                    ...
                                    <table class="table table-hover">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">    <select class="form-control select" name="trd" id="trd" enabled>
                                                <option>Select Class</option>
                                   ...
                                   <div class="form-group">
                                        <label class="col-md-3 col-xs-3 control-label">Edit trader</label>
                                        <div class="col-md-3 col-xs-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                         <input type="text" class="form-control" name='tujuandl'>                 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2 col-xs-6">                                     
                                         ...
                                         <input type="date" class="form-control pull-right" name='tanggalttd'>
                                ...
                                <div class="panel-footer">
                                    <button type="reset" class="btn btn-default" onclick="location.href='<?php echo base_url();?>dokumen';">
